...
> **実用上のポイント**: 提案書は最初から完璧である必要はない。対話を通じてある程度まとまったらサイクルを回し、レビューで問題を発見し、再び対話に戻って提案書を詰め直す。サイクルを回すことで、最初には見えなかったゴールが明確になっていく。このプロセス自体が本章の原理——反復サイクル、構造化による意図と設計の分離、外部永続化によるサイクルの維持、satisficingによる出口の判断——を体現している。全てを事前に決める必要はない。このサイクルは、回しながら明確にしていける構造になっている。
